...
PROTECTED='onboarding-status\.json|perf-onboarding-status\.json|journey-map\.md|\.phase4-cycle-state\.json|coverage-expansion-state\.json|\.workflow-approvers\.json|adversarial-findings\.md|\.ledger-integrity\.json|\.agent-process-table\.json|flake-quarantine\.md|\.claude/hooks|\.claude/settings(\.local)?\.json'
