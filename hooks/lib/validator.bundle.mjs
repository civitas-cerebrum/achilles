...
// schemas/subagent-returns/phase4-prioritise-author.schema.json
var phase4_prioritise_author_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://civitas-cerebrum.github.io/element-interactions/schemas/subagent-returns/phase4-prioritise-author.schema.json",
...
// schemas/subagent-returns/probe.schema.json
var probe_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
...
// schemas/subagent-returns/section-agent.schema.json
var section_agent_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
...
var workflow_reviewer_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
...
var onboarding_status_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
  $id: "https://civitas-cerebrum.github.io/element-interactions/schemas/onboarding-status.schema.json",
  title: "Onboarding pipeline status ledger",
  description: "Single source of truth for the onboarding pipeline's state. Owned by the onboarding orchestrator (interactive) or an external automated CLI driver. Read by the workflow-reviewer-* subagents and by the onboarding-ledger-* hooks. Lives at tests/e2e/docs/onboarding-status.json in consumer projects (gitignored \u2014 same pattern as .phase4-cycle-state.json + coverage-expansion-state.json).",
  type: "object",
  additionalProperties: true,
  required: [
    "schemaVersion",
...
// schemas/perf-summary.schema.json
var perf_summary_schema_default = {
  $schema: "https://json-schema.org/draft/2020-12/schema",
...
function cmdValidate(id, dataFile) {
  ...
  if (!schema) {
    console.error("No schema for id: " + id);
    process.exit(2);
  }
  let data;
  try {
    data = (0, import_yaml.parse)(readFileSync(dataFile, "utf8"));
  } catch (e) {
...
function cmdReplace(targetFile, oldFile, newFile, all) {
  ...
  try {
    ...
    console.error("REPLACE_FAIL: " + e.message);
    process.exit(2);
  }
  if (oldStr.length === 0) {
    console.error("REPLACE_FAIL: empty old-string");
    process.exit(2);
  }
  const count = content.split(oldStr).length - 1;
  if (count === 0) {
    console.error("REPLACE_FAIL: old-string not found");
    process.exit(3);
  }
  if (count > 1 && !all) {
    console.error("REPLACE_FAIL: old-string matched " + count + " times (not unique)");
    process.exit(4);
  }
  const out = all ? content.split(oldStr).join(newStr) : content.replace(oldStr, () => newStr);
...
if (cmd === "validate" && args.length === 2) cmdValidate(args[0], args[1]);
  ...
  console.error("Usage: validator.bundle.mjs validate <id> <data-file> | replace <target> <old-file> <new-file> [--all] | tojson <file>");
  process.exit(2);
}
