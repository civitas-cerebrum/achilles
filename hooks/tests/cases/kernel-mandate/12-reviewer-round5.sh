...
#       kernel_mandate_shell_words used awk's default newline record
...
section "kernel-mandate reviewer round-5 regressions"
...
export KERNEL_MANDATE_STATE_DIR="$R5/state"
